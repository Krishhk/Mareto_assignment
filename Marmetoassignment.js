...
function populateProducts(category, products) {
    ...
    products.forEach((product) => {
        ...
        discount.textContent = `Discount: ${calculateDiscount(product.price, product.compare_at_price)}% off`;
...
populateProducts('Men', menProducts);
populateProducts('Women', womenProducts);
populateProducts('Kids', kidsProducts);
showProducts('Men');